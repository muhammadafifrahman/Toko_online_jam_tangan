  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView.builder(
          itemCount: HistoryScreen.length,
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () => {
                setState(() {
                  HistoryScreen = HistoryScreen.where((element) =>
                      element.nama ==
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(HistoryScreen[index].date),
                            Text(HistoryScreen[index].no_order),
                            Text(HistoryScreen[index].nama),
                            Text(HistoryScreen[index].subtotal),
                          ],
                        ),
                      )
                    ],
