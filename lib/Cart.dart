...
import 'package:flutter_application_7/model/CartItem.dart';

class Cart extends StatefulWidget {
  const Cart({super.key});

  @override
  State<Cart> createState() => __CartState();
}
            ...
            return InkWell(
              ...
              child: Row(children: [
                Image(
                    width: 100,
                    height: 100,
                    image: NetworkImage(Cart[index].gambar)),
                Container(
                  padding: EdgeInsets.only(left: 10, right: 10),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(Cart[index].nama),
                      Text(Cart[index].harga),
                    ],
                  ),
                )
              ]),
